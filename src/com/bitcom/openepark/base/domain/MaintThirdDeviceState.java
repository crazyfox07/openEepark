...
public class MaintThirdDeviceState {
    private String nid;
    ...
    private Integer continueFaultNum;
    ...
    public Integer getContinueFaultNum() {
        return this.continueFaultNum;
    }


    public void setContinueFaultNum(Integer continueFaultNum) {
        this.continueFaultNum = continueFaultNum;
    }
